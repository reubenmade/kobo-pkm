...
// BBox is a growable dirty-region rectangle (inclusive coordinates), ported
// from riddle's fb::BBox.
type BBox struct {
	X0, Y0, X1, Y1 int
}
...
// Rect returns the box as an image.Rectangle (exclusive max), clamped to r.
